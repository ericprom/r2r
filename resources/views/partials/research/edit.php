<div  ng-controller="ResearchEditController">
  <section class="content-header">
    <h1>
      Research Edit
      <small>แก้ไขงานวิจัย</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Research Edit</li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <button type="submit" class="btn btn-danger pull-right" ng-click="delete()">
          <i class="fa fa-trash"></i> ลบข้อมูลงานวิจัย
        </button>
      </div>
    </div>
  </section>
  <div class="modal fade" id="deleteResearchModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          คุณต้องการที่จะลบ <b>{{ fields.research.title }}</b> ออกจากฐานข้อมูล ใช่หรือไม่?
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">กลับ</button>
          <button class="btn btn-danger btn-ok" ng-click="deleteReseach()">ลบรายการ</button>
        </div>
      </div>
    </div>
  </div>
